...
import img1 from "../assets/Ayush.jpg"
...
const Web_AppDevelopment = () => {
  const profiles = [
    {
      name: "Ayush Shrestha",
      role: "Ayush Shrestha is a young website developer and has expertise in nodejs,express js,html,css,javascript,mysql & mongodb.",
      experience:" 2 Years",
...
export default Web_AppDevelopment;
